 ...
 */
	...
	$config['sys']['dev'] = 				array('127.0.', '192.168.', '10.100.'); // Serveurs de développement
	...
	// Cookie
	$config['cookie']['encode'] =			false;									// Indique s'il faut encoder les cookies (nécessite que 'secret' soit défini)
	$config['cookie']['secret'] =			'';										// Clé d'encodage, par exemple générée avec "pwgen -sy 65"
	$config['cookie']['algorithm'] =		NULL;									// Algorithme de chiffrement
	$config['cookie']['mode'] =				NULL;									// Mode de chiffrement par bloc
	$config['cookie']['ssl'] =				false;									// Utilisation de l'identifiant de session SSL
	$config['cookie']['duration'] =			30*86400;								// Durée par défaut des cookies
	...
	$config['mail']['mime'] = 				'1.0';									// Version Mime
	 ...
	 */
	$config['log']['rotate'] = 				7;										// Nombre de jours de conservation des fichiers de log
